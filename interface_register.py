...
def register(page: ft.Page):
    ...
    return cadastro_text, nome_textfield, cpf_textfield, email_textfield, telefone_textfield, data_nascimento_textfield, senha_textfield
...
def insert_customer(nome, cpf, email, telefone, data_nascimento, senha, saldo,
    ...
    if nome == "":
        ...
        try:
            ...
            if nome and cpf_formatado and email and telefone_formatado and data_nascimento_formatado and senha:
                ...
                query_customers = """
                INSERT INTO clientes (nome, cpf, email, telefone, data_nascimento, secret, saldo, id_tipo_conta, id_status_conta)
                ...
                """
                values_customer = (
                    nome, cpf_formatado, email, telefone_formatado, data_nascimento_formatado, password_secret, saldo,
                    id_tipo_conta, id_status_conta
                )
